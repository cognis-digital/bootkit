"""Native cognis-connect emit for bootkit — forward findings to any platform.

Maps bootkit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    bootkit ... --format json | bootkit-emit --to stix
    bootkit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
